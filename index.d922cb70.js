...
*/ /* global define */ (function(factory) {
    ...
    /* globals window:true */ var _window = typeof window !== "undefined" ? window : this;
    var Glider = _window.Glider = function(element, settings) {
        ...
        _._opt = _.opt;
        if (_.opt.skipTrack) // first and only child is the track
    ...
    gliderPrototype.updateControls = function(event) {
        ...
        [].forEach.call(_.slides, function(slide, index) {
            ...
            if (middle === index || extraMiddle && extraMiddle === index) slideClasses.add("center");
            else {
            ...
            if (isVisible !== wasVisible) _.emit("slide-" + (isVisible ? "visible" : "hidden"), {
                slide: index
            });
        });
        ...
        if (event && _.opt.scrollLock) {
            ...
            _.scrollLock = setTimeout(function() {
                ...
                if (Math.abs(_.ele.scrollLeft / _.itemWidth - _.slide) > 0.02) {
                    if (!_.mouseDown) // Only scroll if not at the end (#94)
                    {
                        if (_.trackWidth > _.containerWidth + _.ele.scrollLeft) _.scrollItem(_.getCurrentSlide());
                    }
                }
    ...
    gliderPrototype.scrollItem = function(slide, dot, e) {
        ...
        if (dot === true) {
            ...
            if (typeof slide === "string") {
                ...
                if (_.opt.slidesToScroll % 1 || _.opt.slidesToShow % 1) slide = _.getCurrentSlide();
                else slide = _.slide;
    ...
    gliderPrototype.scrollTo = function(scrollTarget, scrollDuration, callback) {
        ...
        var animate = function() {
            ...
            if (now < scrollDuration && animateIndex === _.animate_id) _window.requestAnimationFrame(animate);
            else {
    ...
    gliderPrototype.setOption = function(opt, global) {
        var _ = this;
        if (_.breakpoint && !global) _._opt.responsive.forEach(function(v) {
            if (v.breakpoint === _.breakpoint) v.settings = Object.assign({}, v.settings, opt);
        });
        else _._opt = Object.assign({}, _._opt, opt);
        _.breakpoint = 0;
...
//# sourceMappingURL=index.d922cb70.js.map
